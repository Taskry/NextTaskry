...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/app/components/project/Card";
        ...
        return (
            <div className="mx-20 my-10">
                <div className="items-center justify-center">
                    ...
                    <div className="flex items-center justify-center font-bold text-lg py-1">프로젝트 없음</div>
                    <div className="flex items-center justify-center py-1">나만의 첫 프로젝트를 만들어 시작합니다.</div>
                </div>
            </div>
        )
    }
        ...
        <div className="mx-20 my-10">
            ...
            >
                {projectList.map((project,index) => {
                    return (
                        <Card key={index} className="rounded-md  hover:border-main-200 ">
