...
export async function GET(request: Request) {
  ...
  const findData = projectMemberList.filter(projectMember => projectMember.id === id);
...
export async function DELETE(request: Request) {
  ...
  console.log(id)
  projectMemberList = projectMemberList.filter(projectMember => projectMember.user !== id);
  // console.log(projectMemberList)
