...
export default function ProjectPagination({currentPage, totalPage, onPageChange}:ProjectPaginationProps) {
  ...
  return (
    <Pagination>
      <PaginationContent>
        ...
        <PaginationItem>
          <PaginationNext
            onClick={()=>(currentPage < totalPage ? onPageChange(nextGroupPage) : undefined)} 
